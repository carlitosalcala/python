...
# modify nextDay(year, month, day) to user daysInMonth(year, month)
# test nextDay(year, month, day) using stub daysInMonth
# modify daysInMonth(year, month) to be correct except for leap years
# 3
# write isLeapYear(year)
# modify daisInMonth to account for leap years
# test it
# test all
...
def nextDay(year, month, day):
    """Including daysInMonth(v2) Simple version: assume every month has 30 days"""
    if day < daysInMonth:
